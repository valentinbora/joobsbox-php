...
if(settings.icon)
{var precomposed=(settings.iconIsGlossy)?'':'-precomposed';head.append('<link rel="apple-touch-icon'+precomposed+'" href="'+settings.icon+'" />');}
if(settings.fixedViewport)
{head.append('<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;"/>');}
if(settings.fullScreen)
{head.append('<meta name="apple-mobile-web-app-capable" content="yes" />');if(settings.statusBar)
...
{currentWidth=window.innerWidth;currentHeight=window.innerHeight;var orient=currentWidth<currentHeight?"profile":"landscape";document.body.setAttribute("orient",orient);setTimeout(scrollTo,100,0,1);}
