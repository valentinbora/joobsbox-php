...
/**
 * @see categoriesIteratorObject()
 */
require_once("categoriesIterator.php");
 ...
 * @package Joobsbox_Models
 */
//if(!class_exists("Model_Jobs", false))
class Model_Jobs extends EventsFilters {
	protected $_db;
	protected $_conf;
    ...
    public function fetchAllJobs($returnImmediately=1, $includeNonPublic=false) {
		...
		return new jobFetchObject($select, $this->_db);
    }
	...
	public function fetchCategories() {
		...
		return categoriesIterator($categories);
	}
